/* eslint-disable */
const { Language, util } = require('Nasa');
...
module.exports = class extends Language {
	...
	constructor(...args) {
		...
		this.language = {
			...
			COMMAND_UNLOAD_DESCRIPTION: 'Unloads the one piece.',
			...
			COMMAND_RELOAD_DESCRIPTION: 'Reloads a one piece, or all pieces of a one store.',
			...
			COMMAND_INVITE: () => [
				`To invite Issei Hyoudou to your Discord server, use this link:`,
			...
			COMMAND_INFO: [
				"Issei Hyoudou is a Discord bot for every Discord server.",
				...
				'',
				'You can find more information on Issei Hyoudou at these links:',
			...
			NO_DEFINITION_FOUND: 'I couldn\'t find that word in the dictionary.',
			COMMAND_STATS: (memUsage, uptime, users, guilds, channels, NasaVersion, discordVersion, processVersion, message) => [
				'= STATISTICS =',
				'',
