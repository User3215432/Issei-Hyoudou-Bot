...
module.exports = class extends Command {
  constructor(...args) {
    ...
    this.customizeResponse('number',
      'You need to give me the number of the song you want to remove.'
    );
  }
  ...
  async run(message, [number]) {
    ...
    if (number <= 0) throw 'Look, I am no expert in maths, but I kinda expected a number bigger than 0 ...';
